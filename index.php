...
<body>
    ...
    <section class="hero-section text-center">
        <div class="container">
            ...
            <h1 class="display-4 fw-bold mb-4">Welcome to Apna Bank</h1>
    ...
    <footer class="bg-light py-4 mt-5">
        <div class="container text-center">
            <p class="mb-0">© <?php echo date('Y'); ?> Apna Bank Financial. All rights reserved.</p>
            <p class="text-muted small mb-0">Made by Jenish, Pal and Riya  </p>
        </div>
    </footer>
